		...
		<div style={{ marginBottom: 5 }}>
			{
				isMine ? (<div style={{ display: 'flex', flexDirection: 'row-reverse', alignItems: 'center' }}>
					<div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-around', backgroundColor: '#3A6EA5', padding: 5, borderRadius: 5, color: 'white' }}>
						{/* <div style={{ fontSize: '0.7rem', display: 'flex', justifyContent: 'flex-end' }}>
							{name}:
						</div> */}
						<div style={{ maxWidth: '80%', fontSize: '1rem', overflowWrap: 'break-word' }}>
							{message}
						</div>
					</div>
					...
					<div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', justifyContent: 'space-around', backgroundColor: '#3A6EA5', paddingRight: 20, paddingLeft: 15, borderRadius: 5, color: 'white', position: 'relative' }}>
